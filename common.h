...
#define FOR5D(x1, x2, x3, x4, x5, n1, n2, n3, n4, n5) \
for(UINT x1 = 0; x1 < n1; x1++) for(UINT x2 = 0; x2 < n2; x2++) for(UINT x3 = 0; x3 < n3; x3++) for(UINT x4 = 0; x4 < n4; x4++) for(UINT x5 = 0; x5 < n5; x5++)
// compare max value
